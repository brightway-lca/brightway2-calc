...
def test_load_arrays_string():
    ...
    expected_array = np.asarray(
        [
            (10, MAX_SIGNED_32BIT_INT, MAX_SIGNED_32BIT_INT, 17, 1),
            (11, MAX_SIGNED_32BIT_INT, MAX_SIGNED_32BIT_INT, 17, 10),
        ],
        dtype=dtype,
    )
...
def test_load_arrays_bytesio():
    ...
    expected_array = np.asarray(
        [
            (10, MAX_SIGNED_32BIT_INT, MAX_SIGNED_32BIT_INT, 17, 1),
            (11, MAX_SIGNED_32BIT_INT, MAX_SIGNED_32BIT_INT, 17, 10.2),
        ],
        dtype=dtype,
    )
